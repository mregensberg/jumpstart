...
def add_template_repository_to_source_path
  if __FILE__ =~ %r{\Ahttps?://}
    ...
    git clone: [
      "--quiet",
      "https://github.com/mregensberg/jumpstart.git",
      tempdir
...
def add_asset_precompilation_check
  content = 'config.assets.check_precompiled_asset = false'
...
def add_vue_examples
  # remove autogenerated templates
  run "rm app/javascript/app.vue app/javascript/packs/hello_vue.js"
end
...
after_bundle do
  ...
  copy_templates
  add_asset_precompilation_check
  add_vue
  add_whenever
  add_sitemap
